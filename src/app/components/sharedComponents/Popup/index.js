...
import "./Popup.scss";
import { addBlogPost, putBlogPost } from '../../../redux/actions/BlogPostActions';

function Popup (props) {
    const { ID, labels, setLabels, visible, closeDialog, addBlogPost, putBlogPost } = props;       
                    ...
                    <form onSubmit={handleSubmit} className="k-form">
                        <fieldset>                                            
                            <label className="k-form-field">
                                <span>Title</span>
                                <input name="title" onChange={handleChange} value={labels.title} className="kk-textbox" type="text" required placeholder="Title of the post" />
                            </label>
                            <label className="k-form-field">
                                <span>Text</span>                                                
                                <textarea name="text" onChange={handleChange} value={labels.text} className="kk-textarea" placeholder="Text of the post" ></textarea>
                            </label>
                        </fieldset>
